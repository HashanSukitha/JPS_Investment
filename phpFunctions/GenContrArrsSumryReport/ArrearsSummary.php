...
$pdf->SetFont('Arial','',8);	
$pdf->Cell(20,5,'Contract No','LTB',0,'C',0);	
$pdf->SetFont('Arial','',11);
$pdf->Cell(100,5,'Client Name','LTB',0,'C',0);
$pdf->SetFont('Arial','',8);
$pdf->Cell(20,5,'Contract Amt','LTB',0,'C',0);
$pdf->Cell(20,5,'Arrears Amt','LTB',0,'C',0);	
$pdf->Cell(20,5,'Arrears Days','LTB',0,'C',0);	
$pdf->Cell(20,5,'Deposit','LTBR',0,'C',0);
$pdf->WriteHTML('<BR>');				
//===========================================================================================================================================
		...
		$result =mysqli_query($con,"CALL RPT_CONTR_ARREARS_DET()");
				...
				$ClEmail='';
							...
							while($row = (mysqli_fetch_assoc($result)))
							{
								...
								$pdf->Cell(20,5,$ContrAmt,'LTB',0,'R',0);
								$pdf->Cell(20,5,$contrPnalty,'LTB',0,'R',0);
								$pdf->Cell(20,5,$Ddiff,'LTB',0,'R',0);
								$pdf->Cell(20,5,$ContrDepAmt,'LTBR',0,'R',0);
								$pdf->WriteHTML('<BR>');
...
//client details and contract details
					...
					$pdf->SetFont('Arial','',11);	
					$pdf->Cell(20,5,$row["CNTRNO"],'LTB',0,'C',0);
					$pdf->SetFont('Arial','',9);
					$pdf->Cell(100,5,'('.$clCode.') '.$clName,'LTB',0,'L',0);
		...
		echo '<table border="0" style="width:600px;">
				...
				//=========================================================================================================================	
							...
							$pdf->SetFont('Arial','',10);
							$pdf->Cell(20,5,$ContrAmt,'LTB',0,'R',0);
							$pdf->Cell(20,5,$contrPnalty,'LTBR',0,'R',0);
							$pdf->Cell(20,5,$Ddiff,'LTB',0,'R',0);
							$pdf->Cell(20,5,$ContrDepAmt,'LTBR',0,'R',0);
							$pdf->WriteHTML('<BR>');
